...
describe 'user sees individual book information' do
  before(:each) do
    ...
    @review_3 = @book_1.reviews.create(title: "This is review 3", explanation: "This is another explanation of the review", score: 4, user: user_3)
    @review_4 = @book_1.reviews.create(title: "This is review 4", explanation: "This is one more explanation of the review", score: 5, user: user_4)
    @review_5 = @book_1.reviews.create(title: "This is review 5", explanation: "This is one more explanation of the review", score: 2, user: user_5)
    @review_6 = @book_1.reviews.create(title: "This is review 6", explanation: "This is one more explanation of the review", score: 2, user: user_6)
    @review_7 = @book_1.reviews.create(title: "This is review 7", explanation: "This is one more explanation of the review", score: 1, user: user_7)
  ...
  it 'user sees basic attributes' do
    ...
    expect(page).to have_content("Average Review Score: #{@book_1.average_score}")
  end
